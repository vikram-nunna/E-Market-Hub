...
export default function Authorization() {
    ...
    useEffect(() => {
        axios
            .get("https://zesty-salamander-86d073.netlify.app" + "/dealer/pending")
            .then((res) => {
                console.log(res);
                setIsLoading(false);
    ...
    const handleApproveDealer = (id) => {
        ...
        console.log(id);
        axios
            .post("https://zesty-salamander-86d073.netlify.app" + "/dealer/approve/" + id)
            .then((res) => {
                console.log(res);
    ...
    const handleRejectDealer = (id) => {
        ...
        console.log(id);
        axios
            .post("https://zesty-salamander-86d073.netlify.app" + "/dealer/reject/" + id)
            .then((res) => {
                console.log(res);
                openAlert("success", res.data.message);
                setTimeout(() => {
